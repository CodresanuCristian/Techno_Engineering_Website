        ...
        $('.about .meet .employee-wrap').fadeOut(function(){
            ...
            switch (emp_numb){
                case 2: 
                    ...
                    $('.about #about-employee1 h6').html('President');
                    ...
                    $('.about #about-employee2 h6').html('President');
                ...
                case 3:
                    ...
                    $('.about #about-employee1 h6').html('PR & International Administration Director');
                    $('.about .meet-box #img-emp1').attr('src','/img/CeraselaAngelescu.png');
                    ...
                    $('.about #about-employee2 h6').html('Administrative & Financial Manager');
                ...
                case 5: 
                    ...
                    $('.about #about-employee1 h6').html('Head of Legal Department International');
                    ...
                    $('.about #about-employee2 h6').html('Claims Manager');
                    ...
                    $('.about #about-employee3 h6').html('Head of Forensic International');
                    ...
                    $('.about #about-employee4 h6').html('Head of Contracts Department');
                    ...
                    $('.about #about-employee5 h6').html('Head of QS & Quantum Department International');
                ...
                case -2: 
                    ...
                    $('.about #about-employee1 h6').html('Civil Engineering');
                    ...
                    $('.about #about-employee2 h6').html('Senior QS Advisor');
                ...
                case 10: 
                    ...
                    $('.about #about-employee2 h6').html('Head of Quantity Surveying & Quantum Department');
                    ...
                    $('.about #about-employee5 h6').html('Manager of the Translation & Editing Department');
                    ...
                    $('.about #about-employee6 h6').html('IT Specialist');
                    ...
                    $('.about #about-employee7 h6').html('Deputy Manager');
                    ...
                    $('.about #about-employee8 h5').html('ALEXANDRU PALADE');
                    $('.about #about-employee8 h6').html('Unit Chief Quantity Surveyor ');
                    $('.about .meet-box #img-emp8').attr('src','/img/no-user-image.png');
                    $('.about #about-employee8 #linkedin').attr('href','https://www.linkedin.com/in/alexandru-palade-a1a802172/');
                    $('.about #about-employee9 h5').html('RAZVAN DOBRE');
                    $('.about #about-employee9 h6').html('Unit Chief Quantity Surveyor');
                    $('.about .meet-box #img-emp9').attr('src','/img/Razvan Dobre.jpg');
                    $('.about #about-employee9 #linkedin').attr('href','https://www.linkedin.com/in/razvan-dobre-2aaa17168/');
                    $('.about #about-employee10 h5').html('LIVIU MUSA');
                    $('.about #about-employee10 h6').html('Chief Accountant');
                    $('.about .meet-box #img-emp10').attr('src','/img/Liviu Musa.jpg');
                    $('.about #about-employee10 #linkedin').attr('href','https://www.linkedin.com/company/techno-engineering-&-associates/');
                    break;
            }
        }).fadeIn();
    });
...
function ModalDetails(op, emp_id)
{
    ...
    if (op == 'about-meet-op5'){
        ...
        if (emp_id == 'about-employee8'){
            $('.about .modal-title').html('ALEXANDRU PALADE');
            $('.about .modal-body p').html('Alexandru Palade currently holds the position of Unit Chief Quantity Surveyor at Techno Engineering & Associates, being responsible for the preparation of the construction claims. Typically, this would involve identification of the potential damages from pitch to completion, arise from the developing of the contract activities, gathering and processing of all the supporting particulars endorsing various heads of claim applicable to each distinctive type of contract, calculation and presenting to all the contract’s parties the results and the related argumentation in respect of the quantum assessment of the damages. Within TE&A’s team, he enlarged his experience on claim preparation such as prolongation cost claims, loss of efficiency or idleness claims, price escalation and price adjustment claims, changes in legislation claims, financing charges claims and loss of profit claims, just to number a few.<br><br>During his earlier assignments, he has gained valuable experience as a designer, consulting engineer, project manager and works supervisor within projects of various disciplines in Romania, Belgium and UK, providing him with a global understanding of project management and project technical challenges. He has dealt with many kinds of projects including both civil and industrial types, having an active role on all stages from scratch, tendering and preliminary design up to the site implementation. Alexandru holds skills in developing relationships with Contractor’s Representatives in order to secure supporting particulars for the quantum damages analysis services and is adept in his ability to perform quantum calculations for cost based claims in infrastructure construction projects. He possesses a broad range of technical, personal effectiveness and leadership skills and the use of rigorous logic and methodologies to ascertain effective solutions to complex problems. ');
            $('.about .modal-footer #linkedin-modal').attr('href','https://www.linkedin.com/in/alexandru-palade-a1a802172/');
        }
