    ...
    $('.testimonials .footer').on('click', '.employee-box img', function(){
        ...
        switch (employee_id){
            case 'employee1':
                ...
                $('.testimonials .section #avatar').attr('src','/img/Denitsa Harizanova.jpg');
            ...
            case 'employee2':
                ...
                $('.testimonials .section #avatar').attr('src','/img/Violeta Dinu.jpg');
            ...
            case 'employee3':
                ...
                $('.testimonials .section #avatar').attr('src','/img/no-user-image.png');
            ...
            case 'employee9':
                ...
                $('.testimonials .section #avatar').attr('src','/img/Ioana Otilia Isac.jpg');
