<div class='about'>
    <!-- OVERVIEW ===============================================================================-->
    <div class='container-fluid overview mb-5 pb-5'>
        <h1 class='mb-5'>TE&A Overview</h1>
        <div class='overview-text'>
            <p>Our offices are located in Romania, Bulgaria and Qatar and as part of our continuing expansion programme, we plan to open offices in other strategic venues in the near future.</p>
            <p>TE&A’s team has the expertise and experience to deliver the highest quality advice on contractual, construction law and technical matters across a wide range of construction industry sectors, which is not limited to our more specialist areas within the civil engineering major infrastructure sectors. Our experts are proficient at successfully utilising diverse procurement methods. The scope of our credentials and expertise allows us to work with clients from a variety of different countries, cultures and legal backgrounds. We achieve rapid and efficient performance at minimal cost to our clients.</p>
            <p>Our main area of expertise is Contract Management, Dispute Resolution and Arbitral Proceedings, International Construction Law, the preparation of Contractor’s Claims, which includes Forensic Delay and Quantum Analysis, Planning Engineering and Quantity Surveying. We also specialize in providing Due Diligence and Technical Services to bankers and contractors in respect of the following:</p>
            <ol>
                <li>Evaluation of contractors and banking risks by reference to the project contractual provisions and environment;</li>
                <li>Periodic review and update proposals in respect of contractors’ entire contract management procedure including basic risk areas, administration, and so forth;</li>
                <li>Monitoring of the evolution of contractors’ Programmes of the Works and relevant project Cash Flows.</li>
            </ol>
        </div>
    </div>
    <div class='boxes'>
    ...
    <div class='meet'>
        ...
        <nav class="about-meet-nav my-5 container-fluid">
            <ul class="nav">
                <li><a class="about-meet-active" id="about-meet-op1">SHAREHOLDERS PARTNERSHIP</a></li>
                <li><a id="about-meet-op2">SENIOR MANAGEMENT</a></li>
                <li><a id="about-meet-op3">CLAIMS MANAGERS</a></li>
                <li><a id="about-meet-op4">SENIOR ADVISORS</a></li>
                <li><a id="about-meet-op5">MANAGEMENT</li>
            </ul>
        </nav>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-header justify-content-center">
                    <h2 class="modal-title">GIOVANNI DI FOLCO</h2>
            ...
            <div class='row align-items-center'>
                <div class='col-lg-7'>
                    ...
                    <div class='values-block d-flex justify-content-center flex-wrap my-5'>
                        ...
                        <p id='val3'>ACCOUNTABILITY</p>
                        <p id='val4'>INTEGRITY</p>
                        <p id='val5'>COMMITMENT</p>
                        <p id='val6'>ETHICS</p>
                    </div>
                    <div class='val-text'>
